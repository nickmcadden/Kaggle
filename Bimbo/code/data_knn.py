...
def load(m_params):
	...
	test_ids = test['id']
	train.drop(['c1000','c250','c50','pc10','pc100','pc30','ProdClientLastWeekUnits','SalesUnitsWeek', 'SalesPesosWeek','ReturnsUnitsWeek', 'ReturnsPesosWeek', 'AdjDemand','DepotId', 'ChannelId', 'RouteId', 'ClientId', 'ProductId'], axis=1, inplace=True)
	test.drop(['id','c1000','c250','c50','pc10','pc100','pc30','DepotId', 'ProdClientLastWeekUnits', 'ChannelId', 'RouteId', 'ClientId', 'ProductId'], axis=1, inplace=True)

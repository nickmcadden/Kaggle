...
import data_decayed_avg as data
import argparse
...
parser.add_argument('-n','--n_rounds', help='Number of Boost iterations', type=int, default=250)
...
if m_params['cv']:
	...
	model_pathname = '../output/pred_xgb_decayed_avg_minus_weeknum' + str(m_params['n_rounds'])

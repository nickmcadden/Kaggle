...
def load(m_params):
	...
	#prod_med2 = pd.read_csv(inputdir + 'groupby_product_median_units.csv')
	...
	#prod_client_med = pd.read_csv(inputdir + 'groupby_product_client_median_units.csv')
	print('product route...')
	...
	#prod_c1000_med = pd.read_csv(inputdir + 'groupby_product_c1000_median_units.csv')
	...
	#prod_c250_med = pd.read_csv(inputdir + 'groupby_product_c250_median_units.csv')
	...
	#prod_c50_med = pd.read_csv(inputdir + 'groupby_product_c50_median_units.csv')

...
xgb_param = {'silent' : 1, 'max_depth' : 5, 'alpha': 3, 'eval_metric': 'rmse', 'objective': 'reg:linear', 'eta': m_params['eta'], 'min_child_weight': 2, 'subsample': 0.7, 'colsample_bytree': 0.5}
...
if m_params['cv']:
	...
	model_pathname = '../output/pred_xgb_log_means' + str(m_params['n_rounds'])

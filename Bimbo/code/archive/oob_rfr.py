...
print("Bimbo: Random Forest...\n") 
clf =  RandomForestRegressor(n_estimators=500, verbose=1, max_features=7, min_samples_split= 3, max_depth=10, n_jobs=-1, min_samples_leaf=2)
...
if m_params['cv']:
	...
	oob_pred_filename = '../output/oob_pred_rfr_' + str(np.mean(scr))
	sub_pred_filename = '../output/sub_pred_rfr_' + str(np.mean(scr))

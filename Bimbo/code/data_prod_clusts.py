...
def load(m_params):
	...
	test_ids = test['id']
	train.drop(['ProdClientLastWeekUnits','SalesUnitsWeek', 'SalesPesosWeek','ReturnsUnitsWeek', 'ReturnsPesosWeek', 'AdjDemand','DepotId', 'ChannelId', 'RouteId', 'ClientId', 'ProductId'], axis=1, inplace=True)
	test.drop(['id','DepotId', 'ProdClientLastWeekUnits', 'ChannelId', 'RouteId', 'ClientId', 'ProductId'], axis=1, inplace=True)

...
net['new_output'] = DenseLayer(net['pool5/7x7_s1'], num_units=8, nonlinearity=softmax, W=lasagne.init.Normal(0.01)) 
...
for name, layer in net.items(): 
    ...
    if name in ['new_output', 'pool5/7x7_s1','inception_5b','inception_5a']:

...
def load(m_params):
	...
	if getcached:
		X = pkl.load(open('../input/X.p','rb'))
		y = pkl.load(open('../input/y.p','rb'))
		X_sub = pkl.load(open('../input/X_sub.p','rb'))
		ids = pkl.load(open('../input/ids.p','rb'))
		return X, y, X_sub, ids
	...
	pkl.dump(X, open('../input/X.p', 'wb'))
	pkl.dump(y, open('../input/y.p', 'wb'))
	pkl.dump(X_sub, open('../input/X_sub.p', 'wb'))
	pkl.dump(ids, open('../input/ids.p', 'wb'))

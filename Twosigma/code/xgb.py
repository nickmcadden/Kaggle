...
xgb_param = {'silent' : 1, 'eta': 0.02, 'max_depth':6, 'objective': 'multi:softprob', 'eval_metric': 'mlogloss', 'subsample': 0.7, 'num_class': 3, 'min_child_weight': 2, 'colsample_bytree': 0.7}

...
print("Two Sigma: Random Forest...\n") 
clf =  RandomForestRegressor(n_estimators=500, verbose=1, max_features=45, criterion= 'mse', min_samples_split= 5, max_depth=19, n_jobs=-1, min_samples_leaf=2)
...
oob_pred_filename = '../output/oob_pred_rfreg_' + str(np.mean(scr))
sub_pred_filename = '../output/sub_pred_rfreg_' + str(np.mean(scr))

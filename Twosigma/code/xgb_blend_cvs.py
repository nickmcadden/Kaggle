...
oob_models = [	'oob_pred_xgb_cvs_0.523024589033.p',
...
if m_params['cv']==True:
	...
	print oob_pred[1:10]
	print np.mean(scr)
	oob_filename = '../output/oob_blend_xgb_cvs_' + str(np.mean(scr)) + '.p'
	...
	model_pathname = '../output/pred_xgb_cvs_blend_' + str(m_params['n_rounds'])

...
clf =  ExtraTreesClassifier(n_estimators=1000, verbose=1, max_features=65, criterion= 'entropy', min_samples_split= 4, max_depth=17, n_jobs=-1, min_samples_leaf=2)
...
preds.to_csv('../output/etc' + '.csv', index=False)

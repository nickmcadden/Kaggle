...
clf =  RandomForestClassifier(n_estimators=500, verbose=1, max_features=45, criterion= 'entropy', min_samples_split= 5, max_depth=19, n_jobs=-1, min_samples_leaf=2)
...
preds.to_csv('../output/rf_' + str(np.mean(scr)) + '.csv', index=False)

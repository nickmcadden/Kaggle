...
parser.add_argument('-n','--n_rounds', help='Number of Boost iterations', type=int, default=420)
...
oob_models = [	'oob_pred_rfentropy_0.558171910933.p',
				...
				'oob_pred_xgb_cvs_0.523024589033.p',
				'oob_pred_xgb_cvs_0.523143897969.p',
				'oob_pred_xgb_cvs_0.524092640497.p',
				'oob_pred_xgb_cvs_0.525664842807.p',
				'oob_pred_xgb_cvs_0.511760776066.p',
				'oob_pred_xgb_cvs_reg_0.211198318154.p']
...
if m_params['cv']==True:
	...
	for i, (tr_ix, val_ix) in enumerate(kf):
		...
		clf = xgb.train(xgb_param, dtrain, 420, evals=([dtrain,'train'], [dval,'val']))
	...
	clf = xgb.train(xgb_param, dtrain, 420, evals=([dtrain,'train'], [dtrain,'train']))

	print('Predicting on test set...')
	pred = clf.predict(dtest)

	print("Saving Results.")
	model_pathname = '../output/pred_xgb_blend_all_' + str(m_params['n_rounds'])

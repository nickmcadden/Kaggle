...
for c1 in topcols:
	...
	for c2 in topcols:
		if c1 == c2:
			continue
		train_new_eng[c1+'*2/'+c2] = train[c1]*train[c1] / np.clip(train[c2]*train[c2], 0.001, 10000000000)
	...
	for c2 in topcols:
		if c1 == c2:
			continue
		if imp.ix[c1+'*2/'+c2, 'score'] / sp.maximum(imp.ix[c1, 'score'], imp.ix[c2, 'score']) > 1.2:

...
import data_linear_features as data
import argparse
...
if m_params['cv']:
	...
	oob_pred_filename = '../output/oob_pred_etclinfeatures_' + str(np.mean(scr))
	sub_pred_filename = '../output/sub_pred_etclinfeatures_' + str(np.mean(scr))

...
#include <ncaa_exponential_gen.htp>

model_data::model_data(int argc,char * argv[]) : ad_comm(argc,argv)
{
  nobs.allocate("nobs");
  decaymod.allocate("decaymod");
  wscore.allocate(1,5018,"wscore");
  lscore.allocate(1,5018,"lscore");
  wteam.allocate(1,5018,"wteam");
  lteam.allocate(1,5018,"lteam");
  yearlag.allocate(1,5018,"yearlag");
  xmean.allocate(1,5018,"xmean");
  ymean.allocate(1,5018,"ymean");

...
model_name = "xgb_massey"

xgb_param = {'silent' : 1, 'max_depth' : 6, 'eta': m_params['eta'], 'objective':'reg:linear', 'min_child_weight':6, 'colsample_bytree':0.7, 'subsample':0.7}

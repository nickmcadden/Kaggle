...
model1 = pkl.load(open('../output/oob_pred_extrees_0.459683857289.p','rb'))
model2 = pkl.load(open('../output/oob_pred_xgb_0.460781137403.p', 'rb'))
model3 = pkl.load(open('../output/oob_pred_extrees_0.4611306639.p', 'rb'))
...
print('model avg 1 2', log_loss(y, (model1*0.6+model2*0.4)))

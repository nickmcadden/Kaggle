...
train <- read.csv("~/kaggle/santander/input/train.csv")
test  <- read.csv("~/kaggle/santander/input/test.csv")
...
preds[tc['saldo_var26'] > 8381.29] = 0
...
write.csv(submission, "~/kaggle/santander/output/thescript_submission.csv", row.names = F)
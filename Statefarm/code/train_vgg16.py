...
for name, layer in net.items():  
    ...
    elif name in ['conv5_1', 'conv5_2']:
	    layer_lr = learning_rate / 5
    elif name in ['conv4_1', 'conv4_2']:
        layer_lr = learning_rate / 10
    elif name in ['conv3_1', 'conv3_2']:
        layer_lr = learning_rate / 20
    else:
        layer_lr = learning_rate / 50
    if name != 'fc8':

...
xgb_param = {'silent' : 1, 'max_depth' : 9, 'alpha' : 4.6, 'lambda' : 3.4, 'gamma' : 0.5, 'eta': m_params['eta'], 'objective':'binary:logistic', 'eval_metric':'auc', 'min_child_weight':6, 'colsample_bytree':0.36, 'subsample':0.73}

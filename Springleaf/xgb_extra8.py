...
if os.path.isfile(model_name + '.model'):
	m_params['n_rounds'] = 	8000
else:
	print("model not available")
	exit()

xgb_param = {'silent' : 1, 'max_depth' : 9, 'alpha' : 4.5, 'lambda' : 3.3, 'gamma' : 0.5, 'eta': m_params['eta'], 'objective':'binary:logistic', 'eval_metric':'auc', 'min_child_weight':6, 'colsample_bytree':0.42, 'subsample':0.72}
